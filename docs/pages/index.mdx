...
export function Cobe() {
  ...
  return <div style={{
    ...
    <div style={{
      ...
      <span style={{ fontSize: '1.2em' }}>Connect Data API on Chain</span>
    </div>
    <canvas
      ref={canvasRef}
      onPointerDown={(e) => {
...
<div style={{ textAlign: 'center' }}>
  <div className="inline-flex justify-center cta-container">
    ...
    <Link href="/docs/quick-start">
      <a className="cta" draggable="false">Built Oracle</a>
    </Link>
  </div>

  <div style={{ marginTop: '2rem' }}/>
  <a href="/docs/introduction" target="_blank" style={{
    color: 'inherit',
    opacity: .5,
    fontSize: 14
  }}>How to quickly and easily use Oracle (Open Oracle) →</a>
</div>
